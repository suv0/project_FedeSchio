	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
				...
				$(this).find('.fp-slides').after('<div class="fp-controlArrow fp-prev"> <img src="images/previous.png"> </div> <div class="fp-controlArrow fp-next"> <img src="images/next.png"> </div>');
		...
		*/
		function addSlidesNavigation(section, numSlides){
            ...
            /*
            Modified by : me@suvo.me
            description : check for the slide type
            if the slide got the class called video-type then put a play icon at the nav item...
            otherwise put associate number at the nav item...
             */
